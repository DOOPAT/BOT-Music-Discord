...
public class SkipCmd extends MusicCommand 
{
    ...
    public void doCommand(CommandEvent event) 
    {
        ...
        {
            event.reply(event.getClient().getSuccess()+" กำลังข้าม **"+handler.getPlayer().getPlayingTrack().getInfo().title+"**");
        ...
        else
        {
            ...
            {
                msg += "\n" + event.getClient().getSuccess() + " กำลังข้าม **" + handler.getPlayer().getPlayingTrack().getInfo().title
